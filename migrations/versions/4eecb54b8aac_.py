...
def upgrade():
    ...
    sa.Column('Krystof', sa.String(), nullable=False),
    sa.Column('Sevcik', sa.String(), nullable=False),
    ...
    op.create_index('ix_loguser_Sevcik', 'loguser', ['Sevcik'], unique=False)
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('karty')
    op.drop_index('ix_loguser_Sevcik', table_name='loguser')
